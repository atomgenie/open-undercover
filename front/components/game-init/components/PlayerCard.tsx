...
export const PlayerCard: React.FC<props> = ({ player }) => {
    ...
    return (
        <div className="h-80 w-64 bg-gray-200 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md flex flex-col justify-center items-center p-4 relative animate-fade-in-scale">
